...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [CommonModule, RouterModule, CartButtonComponent, TranslatePipe, FormsModule, LucideAngularModule],
  template: `
    <!-- Search Overlay -->
    <div 
    ...
    <!-- Mobile Top Info Bar -->
    <div class="lg:hidden bg-black text-white text-xs">
      <div class="px-3 py-2">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <a href="tel:+385 (1) 6407 715" class="flex items-center space-x-1">
            ...
            <a href="mailto:info@solarni-paneli.hr" class="flex items-center space-x-1">
              ...
              <span class="whitespace-nowrap">{{ 'contact.email' | translate }}</span>
            </a>
          </div>
        </div>
      </div>

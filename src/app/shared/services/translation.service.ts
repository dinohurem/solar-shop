    ...
    private translations: Record<SupportedLanguage, Translations> = {
        hr: {
            ...
            b2b: {
                ...
                products: {
                    title: 'Proizvodi za partnere',
                    subtitle: 'Ekskluzivni katalog proizvoda s partnerskim cijenama',
                    loginRequired: 'Prijavite se kao partner da biste vidjeli cijene',
                    loginToViewPrices: 'Prijavite se za pregled cijena',
                    partnerPrice: 'Partnerska cijena',
                    retailPrice: 'Maloprodajna cijena',
                    savings: 'Ušteda',
                    contactForPricing: 'Kontaktirajte nas za cijene',
        ...
        en: {
            ...
            b2b: {
                ...
                products: {
                    title: 'Products for Partners',
                    subtitle: 'Exclusive product catalog with partner pricing',
                    loginRequired: 'Login as a partner to view prices',
